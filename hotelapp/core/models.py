...
class Guest(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True, related_name='guest')
    hotel = models.ForeignKey('HotelPost', on_delete=models.CASCADE, null=True,blank=True)
    room = models.ForeignKey('OurRoom', on_delete=models.CASCADE, related_name='guest_bookings', null=True, blank=True)
...
class Booking(models.Model):
    guest = models.ForeignKey(Guest, on_delete=models.CASCADE, related_name='bookings', null=True, blank=True)
